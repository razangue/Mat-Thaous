...
namespace RaysHotDogs
{
    ...
    public class RayMapActivity : Activity
    {
        ...
        private void UpdateMapView()
        {
            ...
            mapReadyCallBack.MapReady += (sender, args) =>
            {
                ...
                if (googleMap != null)
                {
                    ...
                    makerOptions.SetPosition(rayLocation);
                    makerOptions.SetTitle("Ray's Hot Dogs");
        ...
        private void CreateMapFragment()
        {
            ...
            if (mapFragment != null)
            {
                var googleMapOptions = new GoogleMapOptions().InvokeMapType(GoogleMap.MapTypeSatellite).InvokeZoomControlsEnabled(true).InvokeCompassEnabled(true);
